...
class ActionColumn extends Column
{
     ...
     * @see buttons
     */
    public $template = '{view} {update} {delete} {like}';
    /**
    ...
    protected function initDefaultButtons()
    {
        ...
        if(!isset($this->buttons['like']))
        {
            $this->buttons['like'] = function ($url, $model, $key)
            {
                $options = array_merge(
                    [
                        'title'       => Yii::t('yii', 'Like'),
                        'aria-label'  => Yii::t('yii', 'Like'),
                        'data-method' => 'post',
                        'data-pjax'   => '1',
                    ], $this->buttonOptions
                );
